...
@Component({
  selector: 'app-filter-selector-multiple',
  templateUrl: './filter-selector-multiple.component.html',
  styleUrls: ['./filter-selector-multiple.component.scss']
})
export class FilterSelectorMultipleComponent implements OnInit {
