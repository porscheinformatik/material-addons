...
import { ThrottleClickDemoApiSpecComponent } from './throttle-click-demo-api-spec/throttle-click-demo-api-spec.component';
...
@Component({
  ...
  imports: [TextCodeComponent, ExampleViewerComponent, ThrottleClickDemoApiSpecComponent],
})
